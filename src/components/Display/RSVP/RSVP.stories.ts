...
/**
 * This is a component for rapid serial visual presentation (RSVP) of text.
 * RSVP is a technique to read a text more quickly by presenting only one
 * word at a time. An additional Optimal Recognition Point (ORP) can also
 * help to read more words per minute.
 */
...
export const Default: Story = {
    args: {
        wordsPerMinute: 240,
        loop: true,
        content: 'This is a sample text for the RSVP component.',
    },
};

export const NoHighlightAndNoLoop: Story = {
    args: {
        wordsPerMinute: 240,
        loop: false,
        highlightOrp: false,
...
export const LongText: Story = {
    args: {
        wordsPerMinute: 200,
        loop: false,
        content: `Amet esse adipisicing deserunt fugiat amet eiusmod excepteur sunt cupidatat veniam ad eiusmod sit. Ullamco consectetur esse qui et ullamco tempor quis nisi elit amet labore non Lorem. Non eu in adipisicing fugiat voluptate. Excepteur occaecat magna duis anim officia voluptate dolore cupidatat commodo esse minim pariatur qui consectetur.
